            ...
            <body >
                <div className="full-section">
                    <div className="header-sec">
                        <img src={clickup} alt="image" style={{ height: "70px" }} />
                        <a className="signup-link" href="">Don't have an account?</a>
                    ...
                    <div className="main-body" >
                        <div className="Box">
                            ...
                            <div className="login-div">
                                <button className="login-btn" onClick={handleLogin}><span>Log In</span></button>
